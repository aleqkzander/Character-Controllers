...
/* 
 * This script is made by Unity and belongs to the third person starter asset
 * The script now responsible for booth the third- and firstpersonplayer
 * This script is modified to use the old input system
